...
- [autowarefoundation/autoware](https://github.com/OBIGOGIT/obigo.goasp.autoware)
  - Meta-repository containing `.repos` files to construct an GOASP workspace.
...
- [autowarefoundation/autoware.core](https://github.com/OBIGOGIT/obigo.goasp.autoware.core)
  - Main repository for high-quality, stable ROS packages for Autonomous Driving.
  - Based on [Autoware.Auto](https://gitlab.com/autowarefoundation/autoware.auto/AutowareAuto) and [Autoware.Universe](https://github.com/OBIGOGIT/obigo.goasp.autoware.universe).
- [autowarefoundation/autoware.universe](https://github.com/OBIGOGIT/obigo.goasp.autoware.universe)
...
- [autowarefoundation/autoware_launch](https://github.com/OBIGOGIT/obigo.goasp.autoware_launch)
...
- [autowarefoundation/autoware-documentation](https://github.com/OBIGOGIT/obigo.goasp.autoware-documentation)
